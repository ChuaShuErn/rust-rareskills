...
#[starknet::contract] // macro? this is a contract to expose getter function?
pub mod SimpleVault {
    ...
    #[abi(embed_v0)] // abi? so its to define more functions in SimpleVault?
    impl SimpleVault of super::ISimpleVault<ContractState> {
        ...
        fn withdraw(ref self: ContractState, shares: u256) {
            ...
            let amount_felt252: felt252 = amount.low.into();
            self.token.read().transfer(caller, amount_felt252); // interesting that we have a read() function
            // as if to get the "type"
        }
    }
}
```

Purpose: function similar to an erc4626 vault
The SimpleVault has a storage similar to erc4626, in that it is a token, has a totalSupply, and balance_of mapping
Allows for deposit and withdrawing